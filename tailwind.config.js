		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { 
						opacity: '0.7',
						filter: 'drop-shadow(0 0 30px rgba(0, 212, 255, 0.6)) drop-shadow(0 0 60px rgba(0, 212, 255, 0.4)) drop-shadow(0 0 90px rgba(0, 212, 255, 0.2))'
					},
					'50%': { 
						opacity: '1',
						filter: 'drop-shadow(0 0 30px rgba(0, 212, 255, 0.8)) drop-shadow(0 0 60px rgba(0, 212, 255, 0.6)) drop-shadow(0 0 90px rgba(0, 212, 255, 0.4))'
					}
				},
				'wavefloat': {
			...
			animation: {
				...
				'pulse-glow': 'pulse-glow 3000ms ease-in-out infinite',
				'wavefloat': 'wavefloat 4s ease-in-out infinite',
			},
			transitionDuration: {
				fast: '150ms',
				standard: '250ms',
